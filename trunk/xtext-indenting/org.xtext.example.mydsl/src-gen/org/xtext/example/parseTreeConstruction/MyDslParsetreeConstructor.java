...
protected class Entity_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IInstanceDescription inst) {
		switch(index) {
			case 0: return new Entity_DEDENTTerminalRuleCall_5(parent, this, 0, inst);
			default: return null;
		}	
	}	
...
// INDENT
protected class Entity_INDENTTerminalRuleCall_3 extends UnassignedTextToken {

	public Entity_INDENTTerminalRuleCall_3(AbstractToken parent, AbstractToken next, int no, IInstanceDescription current) {
		super(parent, next, no, current);
	}
	
	public RuleCall getGrammarElement() {
		return grammarAccess.getEntityAccess().getINDENTTerminalRuleCall_3();
	}
...
protected class Entity_Alternatives_4 extends AlternativesToken {
	...
	public Entity_Alternatives_4(AbstractToken parent, AbstractToken next, int no, IInstanceDescription current) {
		super(parent, next, no, current);
	}
	...
	public AbstractToken createFollower(int index, IInstanceDescription inst) {
		switch(index) {
			case 0: return new Entity_PropertiesAssignment_4_0(parent, this, 0, inst);
			case 1: return new Entity_ChildrenAssignment_4_1(parent, this, 1, inst);
			default: return null;
		}	
	}	
...
// properties+=Property
protected class Entity_PropertiesAssignment_4_0 extends AssignmentToken  {
	
	public Entity_PropertiesAssignment_4_0(AbstractToken parent, AbstractToken next, int no, IInstanceDescription current) {
		super(parent, next, no, current);
	}
	
	public Assignment getGrammarElement() {
		return grammarAccess.getEntityAccess().getPropertiesAssignment_4_0();
	}
	...
	protected IInstanceDescription tryConsumeVal() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getPropertyRule().getType().getClassifier())) {
				type = AssignmentType.PRC;
				element = grammarAccess.getEntityAccess().getPropertiesPropertyParserRuleCall_4_0_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createParentFollower(AbstractToken next,	int actIndex, int index, IInstanceDescription inst) {
		if(value == inst.getDelegate() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new Entity_Alternatives_4(parent, next, actIndex, consumed);
			case 1: return new Entity_INDENTTerminalRuleCall_3(parent, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
// children+=Entity
protected class Entity_ChildrenAssignment_4_1 extends AssignmentToken  {
	
	public Entity_ChildrenAssignment_4_1(AbstractToken parent, AbstractToken next, int no, IInstanceDescription current) {
		super(parent, next, no, current);
	}
	
	public Assignment getGrammarElement() {
		return grammarAccess.getEntityAccess().getChildrenAssignment_4_1();
	}
	...
	protected IInstanceDescription tryConsumeVal() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getEntityRule().getType().getClassifier())) {
				type = AssignmentType.PRC;
				element = grammarAccess.getEntityAccess().getChildrenEntityParserRuleCall_4_1_0(); 
				consumed = obj;
				return param;
			}
		}
...
// DEDENT
protected class Entity_DEDENTTerminalRuleCall_5 extends UnassignedTextToken {

	public Entity_DEDENTTerminalRuleCall_5(AbstractToken parent, AbstractToken next, int no, IInstanceDescription current) {
		super(parent, next, no, current);
	}
	
	public RuleCall getGrammarElement() {
		return grammarAccess.getEntityAccess().getDEDENTTerminalRuleCall_5();
	}

	public AbstractToken createFollower(int index, IInstanceDescription inst) {
		switch(index) {
			case 0: return new Entity_Alternatives_4(parent, this, 0, inst);
			case 1: return new Entity_INDENTTerminalRuleCall_3(parent, this, 1, inst);
			default: return null;
		}	
	}	
